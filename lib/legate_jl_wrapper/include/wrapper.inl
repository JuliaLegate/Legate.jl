...
namespace runtime {
     ...
     */
    inline Scalar string_to_scalar(std::string str) 
    {
      return Scalar(str);
    }
     ...
     */
    inline LogicalArray create_unbound_array(const Type& ty, std::uint32_t dim = 1, bool nullable = false)
    {
     ...
     */
    inline LogicalArray create_array(const Shape& shape, const Type& ty, bool nullable = false, bool optimize_scalar = false)
    {
     ...
     */
    inline LogicalStore create_unbound_store(const Type& ty, std::uint32_t dim = 1)
    {
     ...
     * @param optimize_scalar Whether to optimize scalar storage (default false).
     */
    inline LogicalStore create_store(const Shape& shape, const Type& ty, bool optimize_scalar = false)
    {
     ...
     */
    inline LogicalStore store_from_scalar(const Scalar& scalar, const Shape& shape = Shape{1})
    {
