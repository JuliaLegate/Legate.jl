...
JLCXX_MODULE define_julia_module(jlcxx::Module& mod) {
    ...
    mod.method("submit_manual_task", &legate_wrapper::runtime::submit_manual_task);
    /* array management */
    mod.method("create_unbound_array", &legate_wrapper::data::create_unbound_array);
    mod.method("create_array", &legate_wrapper::data::create_array);
    mod.method("create_unbound_store", &legate_wrapper::data::create_unbound_store);
